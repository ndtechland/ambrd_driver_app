import 'package:ambrd_driver_app/controllers/driver_payout_controller.dart';
...
class DriverPayoutHistory extends StatelessWidget {
  ...
  DriverPayouttHistoryController _driverPayoutHistoryController =
      Get.put(DriverPayouttHistoryController());
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          ...
                          Obx(
                            () => _driverPayoutHistoryController
                                    .foundpayouthistorydriver.value.isEmpty
                                ? Center(
                                    child: Text(
                                      "No List",
                                      style: TextStyle(
                                            ...
                                            itemBuilder: (BuildContext context,
                                              ...
                                              final item =
                                                  _driverPayoutHistoryController
                                                      .foundpayouthistorydriver;
                                              DateTime? now =
                                                  item[index]!.payoutDate;
                                              // _driverPayoutHistoryController.getDriverPayoutHistory?.payoutHistory[index].paymentDate;
                                              ///.....
                                              String Date =
