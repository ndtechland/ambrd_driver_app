...
//
//     final driverBookingListModel = driverBookingListModelFromJson(jsonString);

import 'dart:convert';

DriverBookingListModel driverBookingListModelFromJson(String str) =>
    DriverBookingListModel.fromJson(json.decode(str));

String driverBookingListModelToJson(DriverBookingListModel data) =>
    json.encode(data.toJson());

class DriverBookingListModel {
  List<UserListForBookingAmbulance>? userListForBookingAmbulance;

  DriverBookingListModel({
    this.userListForBookingAmbulance,
  });

  factory DriverBookingListModel.fromJson(Map<String, dynamic> json) =>
      DriverBookingListModel(
